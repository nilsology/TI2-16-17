...
\usepackage{ wasysym } % für lightning symbol
...
% //////////////////// eigene Kommandos ////////////////////
\newcommand{\Aufgabe}[2]{#1. Aufgabe \hfill \normalsize\textit{(#2 Punkte)}}
\newcommand{\Teilaufgabe}[1]{#1}
\newcommand{\Quellcode}[3]{\lstset{style=#2}% 1. path/filename, 2. type, 3. beschr.
...
\lstdefinelanguage{asm} {
  morekeywords={
    nop,movl,pushl,popl,cmpl,testl,leal,cmovl,jmp,je,jne,jz,jnz,jg,jge,jl,jle,addl,subl,imul,idiv,cdq,incl,decl,negl,andl,orl,xorl,notl,shrl,shll,sarl,sall,ret,leave,call,setg,setl,setge,setle,setne,sete,movzbl,eax,ebx,ecx,edx,edi,esi,ebp,esp,al,bl,cl,dl
  },
  sensitive=false,
  morecomment=[l]{\#},
  morestring=[b]"
